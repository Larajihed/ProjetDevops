...
public class ChambreController {
    ...
    @PutMapping("/desaffecterChambreDeBloc/{idChambre}")
    public Chambre desaffecterChambreDeBloc(@PathVariable Long idChambre) {
        return chambreService.desaffecterChambreDeBloc(idChambre);
    }

    @GetMapping("/getChambresSansBloc")
    public List<Chambre> getChambresSansBloc() {
        return chambreService.getChambresWithoutBloc();
    }
}
